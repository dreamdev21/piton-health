  ...
  alertok() {
    Platform.select({
      ios: () => {
        AlertIOS.alert(
          "",
          "You have successfully registered. We have sent an verification email on your email address. Please verify your email to login.",
          [
...
const mapDispatchToProps = dispatch => {
  return {
    signupAPI: (first_name, email, password) =>
      dispatch(SignupAction.signupAPI(first_name, email, password)),
