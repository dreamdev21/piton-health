          ...
          >
            {this.state.begin == false && (
              <TouchableOpacity
                ...
                style={styles.bigner}
              >
                <Text style={{ color: "black", fontSize: 15 }}>Beginner</Text>
              </TouchableOpacity>
            )}
            {this.state.begin == true && (
              <TouchableOpacity style={styles.bigner}>
                <Text style={{ color: "#145F82", fontSize: 15 }}>Beginner</Text>
              </TouchableOpacity>
            )}
            ...
            {this.state.advance == false && (
              ...
              >
                <Text style={{ color: "black", fontSize: 15 }}>Advanced</Text>
              </TouchableOpacity>
            )}
            {this.state.advance == true && (
              <TouchableOpacity style={styles.advance}>
                <Text style={{ color: "#145F82", fontSize: 15 }}>Advanced</Text>
              </TouchableOpacity>
            )}
          </View>
          <TouchableOpacity
...
const mapDispatchToProps = dispatch => {
  return {
    updateDifficultyApi: (difficulty, token) =>
      dispatch(UpdateActions.updateDifficultyApi(difficulty, token))
  };
};
